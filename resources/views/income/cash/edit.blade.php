            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ route('income.cash.update', $cash->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{ $cash->name }}" placeholder="Enter The Person Name">
                                    @error('name')
                                ...
                                <div class="form-group col-md-3">
                                    <label>Amount</label>
                                    <input type="number" name="amount" id="amount" step="0.01" class="form-control" value="{{ $cash->amount }}" placeholder="Enter The Amount">
                                    @error('amount')
                                        <div class="alert alert-danger alert-dismissible fade show">
                                            <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="mr-2"><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2"></polygon><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg>
                                            <strong>Error!</strong> {{ $message }}
