            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ route('income.card.store') }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="form-row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                @foreach ($incomeCards as $key=> $incomeCard)
                                    <tr>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('income.card.edit', $incomeCard->id) }}">Edit</a>
                                                    <form action="{{ route('income.card.destroy', $incomeCard->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
