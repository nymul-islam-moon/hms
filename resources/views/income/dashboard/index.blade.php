...
<div class="container-fluid">
    <div class="page-titles">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="{{ route('income.dashboard.index') }}">Dashboard</a></li>
        </ol>
    </div>
    <!-- row -->
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card avtivity-card">
                        ...
                        <div class="effect bg-success" style="top: 121px; left: -2.00003px;"></div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="card avtivity-card">
                        ...
                        <div class="effect bg-secondary" style="top: 141px; left: 261.139px;"></div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="card avtivity-card">
                        ...
                        <div class="effect bg-danger" style="top: -25px; left: 310px;"></div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="card avtivity-card">
                        ...
                        <div class="effect bg-warning" style="top: 141px; left: 310.139px;"></div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="card avtivity-card">
