            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="basic-form">
                        <form action="{{ route('expense.cash.store') }}" method="POST">
                            @csrf
                            @method('POST')
                            <div class="form-row">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                @foreach ($expenseCashes as $key=> $expenseCash)
                                    <tr>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ route('expense.cash.edit', $expenseCash->id) }}">Edit</a>
                                                    <form action="{{ route('expense.cash.destroy', $expenseCash->id) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
                                        ...
                                        <td>{{ $expenseCash->code }}</td>
                                        <td>{{ $expenseCash->expense_by_id }}</td>
                                        <td>{{ $expenseCash->date }}</td>
                                        <td><span class="badge light badge-success">Successful</span></td>
                                        <td>{{ $expenseCash->amount }}  {{ $expenseCash->currency == 1 ? 'Taka' : 'Doller' }}</td>
